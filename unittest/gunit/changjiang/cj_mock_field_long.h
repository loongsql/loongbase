#ifndef CJ_MOCK_FIELD_LONG_INCLUDED
#define CJ_MOCK_FIELD_LONG_INCLUDED
...
*/
class CJ_Mock_field_long : public Field_long {
  std::unique_ptr<CJ_Fake_TABLE> fake_table;
  void initialize() {
    fake_table.reset(new CJ_Fake_TABLE(this));
 ...
 public:
  ...
  CJ_Mock_field_long(bool is_unsigned)
      : CJ_Mock_field_long("field_name", true, is_unsigned) { initialize(); }

  /**
    Creates a nullable column.
    @param name The column name.
  */
  CJ_Mock_field_long(const char *name) : CJ_Mock_field_long(name, true, false) { initialize(); }

  /**
    Creates a nullable column.
    @param name The column name.
  */
  CJ_Mock_field_long(const std::string &&name, bool is_nullable, bool is_unsigned)
      : CJ_Mock_field_long(name.c_str(), is_nullable, is_unsigned) { initialize(); }
  ...
  */
  CJ_Mock_field_long(const char *name, bool is_nullable, bool is_unsigned)
      : Field_long(
            nullptr,                                            // ptr_arg
            8,                                                  // len_arg
...
#endif  // CJ_MOCK_FIELD_LONG_INCLUDED
