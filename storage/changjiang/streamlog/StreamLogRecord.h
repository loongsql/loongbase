...
// StreamLogRecord.h: interface for the StreamLogRecord class.
//
//////////////////////////////////////////////////////////////////////
...
// The purpose of th�s helper class is to supply event to error injector when a
...
class SRLErrorInjectorHelper {
 ...
 public:
  ...
  ~SRLErrorInjectorHelper() {
    ERROR_INJECTOR_EVENT(InjectorStreamLogAppend, srlId);
  }
};
