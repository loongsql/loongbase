...
NullTransform::NullTransform(Transform *src) { source = src; }

NullTransform::NullTransform(bool encrypt, Transform *src) { source = src; }

NullTransform::NullTransform(int mode, Transform *src) { source = src; }

NullTransform::~NullTransform() {}

unsigned int NullTransform::getLength() { return source->getLength(); }
