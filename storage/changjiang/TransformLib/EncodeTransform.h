...
// EncodeTransform.h: interface for the EncodeTransform class.
//
//////////////////////////////////////////////////////////////////////
...
class EncodeTransform : public Transform {
 public:
  EncodeTransform(const char *string) : source(string), encode(true, &source) {}

  EncodeTransform(int length, const UCHAR *data)
      : source(length, data), encode(true, &source) {}
