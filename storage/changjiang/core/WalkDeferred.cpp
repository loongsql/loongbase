...
WalkDeferred::WalkDeferred(DeferredIndex *deferredIdx, Transaction *transaction,
                           int flags, IndexKey *lower, IndexKey *upper)
...
WalkDeferred::~WalkDeferred(void) { deferredIndex->release(); }
