...
static TimeZone timeZoneData[] = {
    TIMEZONE("MIT", "Pacific/Apia", -39600000, noDST, 3600000) TIMEZONE(
        "HST", "Pacific/Honolulu", -36000000, noDST,
        3600000) TIMEZONE("AST", "America/Anchorage", -32400000, USDST,
                          3600000) TIMEZONE("PST", "America/Los_Angeles",
                                            -28800000, USDST,
                                            3600000) TIMEZONE("MST",
                                                              "America/Phoenix",
                                                              -25200000, noDST,
                                                              3600000)
        TIMEZONE("MST", "America/Denver", -25200000, USDST, 3600000) TIMEZONE(
            "CST", "America/Chicago", -21600000, USDST,
            3600000) TIMEZONE("IET", "America/Indianapolis", -18000000, noDST,
                              3600000) TIMEZONE("EST", "America/New_York",
                                                -18000000, USDST, 3600000)
            TIMEZONE("PRT", "America/Caracas", -14400000, noDST, 3600000) TIMEZONE(
                "AST", "America/Halifax",
                -14400000, USDST,
                3600000)
                TIMEZONE("CNT", "America/St_Johns", -12600000, USDST, 3600000)
                    TIMEZONE("AGT", "America/Buenos_Aires", -10800000, noDST,
                             3600000) TIMEZONE("BET", "America/Sao_Paulo",
                                               -10800000, BrazilDST, 3600000)
                        TIMEZONE(
                            "CAT", "Atlantic/Cape_Verde",
                            -3600000, noDST,
                            3600000) TIMEZONE("CAT", "Atlantic/Azores",
                                              -3600000, AzoresDST, 3600000)
                            TIMEZONE("GMT", "Africa/Casablanca", 0, noDST,
                                     3600000) TIMEZONE("ECT", "Europe/Paris",
                                                       3600000,
                                                       ParisDST, 3600000)
                                TIMEZONE("EET", "Europe/Istanbul", 7200000,
                                         InstanbulDST,
                                         3600000) TIMEZONE("ART", "Africa/Cairo",
                                                           7200000,
                                                           CairoDST, 3600000)
                                    TIMEZONE(
                                        "EAT", "Asia/Riyadh",
                                        10800000, noDST,
                                        3600000) TIMEZONE("MET", "Asia/Tehran",
                                                          12600000, TehranDST,
                                                          3600000)
                                        TIMEZONE(
                                            "NET", "Asia/Yerevan", 14400000,
                                            noDST,
                                            3600000) TIMEZONE("PLT",
                                                              "Asia/Karachi",
                                                              18000000, noDST,
                                                              3600000)
                                            TIMEZONE("IST", "Asia/Calcutta",
                                                     19800000, noDST, 3600000)
                                                TIMEZONE("BST", "Asia/Dacca",
                                                         21600000, noDST,
                                                         3600000)
                                                    TIMEZONE(
                                                        "VST",
                                                        ...
                                                        TIMEZONE(
                                                            "JST",
                                                            "Asia/Tokyo", 32400000, noDST, 3600000) TIMEZONE("ACT",
                                                                                                             "Australia/Darwin", 34200000, noDST, 3600000) TIMEZONE("AS",
                                                                                                                                                                    "Australia/Adelaide", 34200000, AustralianDST, 3600000) TIMEZONE("AET",
                                                                                                                                                                                                                                     "Australia/Sydney", 36000000, AustralianDST, 3600000) TIMEZONE("SST",
                                                                                                                                                                                                                                                                                                    "Pacific/Guadalcanal",
                                                                                                                                                                                                                                                                                                    39600000,
                                                                                                                                                                                                                                                                                                    noDST,
                                                                                                                                                                                                                                                                                                    3600000) TIMEZONE("NST",
                                                                                                                                                                                                                                                                                                                      "Pacific/Fiji",
                                                                                                                                                                                                                                                                                                                      43200000,
                                                                                                                                                                                                                                                                                                                      noDST, 3600000) TIMEZONE("NZT",
                                                                                                                                                                                                                                                                                                                                               "Pacific/Auckland", 43200000, AucklandDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                            "America/Adak",
                                                                                                                                                                                                                                                                                                                                                                                                            -36000000, USDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                "Pacific/Rarotonga",
                                                                                                                                                                                                                                                                                                                                                                                                                                                -36000000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                RarotongaDST, 1800000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Pacific/Marquesas",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                -34200000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                noDST,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                0) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            "Pacific/Gambier",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            -32400000, noDST, 0) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          "Pacific/Pitcairn",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          -30600000, noDST, 0) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        "America/Costa_Rica",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        -21600000, noDST, 0) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "Pacific/Easter", -21600000, ChileDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "America/Havana",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               -18000000, CubaDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     "America/Port-au-Prince", -18000000, HaitiDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "America/Grand_Turk", -18000000, GrandTurkDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "America/Cuiaba",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       -14400000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       BrazilDST,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         "America/Halifax",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         -14400000, USDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             "America/Santiago",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             -14400000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ChileDST,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "Atlantic/Stanley",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               -14400000, StandleyDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         "America/Asuncion",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         -14400000, AsuncionDST,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           "America/Miquelon",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           -10800000, USDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "America/Godthab",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               -10800000, GodthabDST,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "Atlantic/South_Georgia", -7200000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 noDST, 0) TIMEZONE("GMT",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    "Europe/London", 0, LondonDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     "Africa/Lagos",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     3600000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     noDST, 0) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        "Africa/Tripoli",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        3600000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        TripoliDST,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          "Europe/Warsaw", 3600000, WarsawDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "Africa/Johannesburg", 7200000, noDST, 0) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    "Europe/Bucharest", 7200000, AzoresDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              "Asia/Amman",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              7200000, AmmanDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   "Europe/Riga", 7200000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   RigaDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              "Asia/Beirut",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              7200000, BeruitDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    "Africa/Windhoek", 7200000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    WindhoekDST,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "Europe/Minsk",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      7200000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      RussianDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    "Asia/Damascus",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    7200000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    DamascusDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   "Asia/Jerusalem", 7200000, JerusalamDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              "Europe/Simferopol",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              10800000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              InstanbulDST,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Asia/Baghdad", 10800000, BagdadDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "Europe/Moscow",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       10800000, RussianDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "Asia/Aqtau",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               14400000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               AzoresDST,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "Asia/Baku",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 14400000, BakuDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "Europe/Samara",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      14400000, RussianDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              "Asia/Kabul",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              16200000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              noDST, 0) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "Asia/Aqtobe", 18000000, AzoresDST,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   "Asia/Bishkek", 18000000, BishkekDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           "Asia/Yekaterinburg",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           18000000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           RussianDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         "Asia/Katmandu", 20700000, noDST, 0) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "Asia/Alma-Ata",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       21600000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       AzoresDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    "Asia/Novosibirsk",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    21600000,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    RussianDST, 3600000) TIMEZONE("xxx",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  "Asia/Rangoon",
                                                            ...
                                                            TIMEZONE(
                                                                ...
                                                                TIMEZONE(
                                                                    ...
                                                                    RussianDST,
                                                                    3600000) TIMEZONE("xxx",
                                                                                      "Asia/Yakutsk", 32400000, RussianDST,
                                                                                      3600000)
                                                                    TIMEZONE(
                                                                        "xxx",
                                                                        "Austra"
...
static Alias aliasData[] = {
    ALIAS("ACT", "Australia/Darwin") ALIAS("AET", "Australia/Sydney")
        ALIAS("AGT", "America/Buenos_Aires") ALIAS("ART", "Africa/Cairo")
            ALIAS("AS", "Australia/Adelaide")
    // ALIAS ("AST","America/Anchorage")
    ALIAS("AST", "America/Halifax") ALIAS("BET", "America/Sao_Paulo")
        ALIAS("BST", "Asia/Dacca")
    // ALIAS ("CAT","Atlantic/Cape_Verde")
    ALIAS("CAT", "Atlantic/Azores") ALIAS("CTT", "Asia/Shanghai")
        ALIAS("CNT", "America/St_Johns") ALIAS("CST", "America/Chicago") ALIAS(
            "EAT", "Asia/Riyadh") ALIAS("ECT", "Europe/Paris")
            ALIAS("CET", "Europe/Paris") ALIAS("EET", "Europe/Istanbul") ALIAS(
                "EST", "America/New_York") ALIAS("GMT", "Africa/Casablanca")
                ALIAS("HST", "Pacific/Honolulu") ALIAS(
                    "IET", "America/Indianapolis") ALIAS("IST", "Asia/Calcutta")
                    ALIAS("JST", "Asia/Tokyo") ALIAS("MET", "Asia/Tehran")
                        ALIAS("MIT", "Pacific/Apia")
    // ALIAS ("MST","America/Phoenix")
    ALIAS("MST", "America/Denver") ALIAS("PRT", "America/Caracas")
        ALIAS("PST", "America/Los_Angeles") ALIAS("NET", "Asia/Yerevan") ALIAS(
            "NST", "Pacific/Fiji") ALIAS("NZT", "Pacific/Auckland")
            ALIAS("PLT", "Asia/Karachi") ALIAS("VST", "Asia/Bangkok") ALIAS(
                "SST", "Pacific/Guadalcanal") ALIAS("Greenwich Mean Time",
                                                    "Africa/Casablanca")
                ALIAS("Greenwich Standard Time", "Africa/Casablanca") ALIAS(
                    "GMT Standard Time",
                    "Europe/London") ALIAS("Romance Standard Time",
                                           "Europe/Paris")
                    ALIAS("W. Europe Standard Time", "Europe/Paris") ALIAS(
                        "Central Europe Standard Time", "Europe/Paris")
                        ALIAS("Egypt Standard Time", "Africa/Cairo") ALIAS(
                            "Saudi Arabia Standard Time", "Asia/Riyadh")
                            ALIAS("Iran Standard Time", "Asia/Tehran") ALIAS(
                                "Arabian Standard Time",
                                "Asia/Yerevan") ALIAS("West Asia Standard Time",
                                                      "Asia/Karachi")
                                ALIAS("India Standard Time",
                                      "Asia/Calcutta") ALIAS("Central Asia "
                                                             "Standard Time",
                                                             "Asia/Dacca")
                                    ALIAS("Bangkok Standard Time",
                                          "Asia/Bangkok") ALIAS("China "
                                                                "Standard Time",
                                                                "Asia/Shanghai")
                                        ALIAS("Tokyo Standard Time",
                                            ...
                                            ALIAS(
                                                ...
                                                "Australia/Darwin")
                                                ALIAS("Sydney Standard Time",
                                                      "Australia/Sydney")
                                                    ALIAS("Central Pacific "
                                                          "Standard Time",
                                                          "Pacific/Guadalcanal")
                                                        ALIAS(
                                                            "New Zealand "
                                                            "Standard Time",
                                                            "Pacific/Fiji") ALIAS("Samoa Standard Time",
                                                                                  "Pacific/Apia")
                                                            ALIAS(
                                                                "Hawaiian "
                                                                "Standard Time",
                                                                "Pacific/"
                                                                "Honolulu") ALIAS("Alaskan Standard Time",
                                                                                  "America/Anchorage")
                                                                ALIAS(
                                                                    "Pacific "
                                                                    "Standard "
                                                                    ...
                                                                    "America/"
                                                                    "Los_"
                                                                    "Angeles") ALIAS("US Mountain Standard Time",
                                                                                     "America/Denver")
                                                                    ALIAS(
                                                                        "Centra"
                                                                        "l "
                                                                        ...
                                                                        ALIAS(
                                                                            ...
                                                                            "ra"
                                                                            "ca"
                                                                            "s") ALIAS("Newfoundland Standard Time",
                                                                                       "America/St_Johns")
                                                                            ALIAS(
...
static const short monthLengths[] = {31, 28, 31, 30, 31, 30,
                                     31, 31, 30, 31, 30, 31};
static int init();
...
DateTime DateTime::convert(const char *dateString, int length) {
  ...
  if (match(TODAY, dateString)) return relativeDay(0);

  if (match(TOMORROW, dateString)) return relativeDay(1);

  if (match(YESTERDAY, dateString)) return relativeDay(-1);
  ...
  if (!relativeDate &&
    ...
    getLocalTime(date.date, &time2);
    throw SQLEXCEPTION(CONVERSION_ERROR, "error converting to date from %s",
                       dateString);
  }
...
int DateTime::lookup(const char *string, const char **table) {
  ...
  *q = 0;
  ...
  for (const char **tbl = table; *tbl; ++tbl)
    if (match(temp, *tbl)) return (int)(tbl - table);
...
int DateTime::getString(int length, char *buffer) {
  tm time;
  getLocalTime(&time);
  snprintf(buffer, length, "%d-%.2d-%.2d", time.tm_year + 1900, time.tm_mon + 1,
           time.tm_mday);
...
double DateTime::getDouble() { return (double)date; }
...
Time Time::convert(const char *timeString, int length) {
  ...
  for (char c = 1; c;) {
    if (q >= endString)
      throw SQLEXCEPTION(CONVERSION_ERROR, "error converting time from %*s",
                         length, timeString);
        ...
        if (q > string) {
          *q = 0;
          if (numeric) {
            ...
            if (state >= 3)
              throw SQLEXCEPTION(CONVERSION_ERROR,
                                 "error converting time from %*s", length,
                                 timeString);
...
int64 DateTime::getDate(short year, short month, short day) {
  ...
  return (int32)(((int64)146097 * century) / 4 + (1461 * ya) / 4 +
                 (153 * month + 2) / 5 + day - BASE_DATE);
}
...
int64 DateTime::getSeconds(tm *time, const TimeZone *timeZone) {
  ...
  if (checkDayLightSavings(time, timeZone)) seconds -= 60 * 60;

  return seconds;
}

bool DateTime::isDayLightSavings(tm *time) {
  if (!time->tm_isdst) return false;

  // Jan to March and November and December are definitely no

  if (time->tm_mon < 3 || time->tm_mon > 9) return false;

  // May through September are definitely yes

  if (time->tm_mon > 3 && time->tm_mon < 9) return true;
  ...
  if (time->tm_mon == 9) {
    ...
    while (sunday + 7 <= 31) sunday += 7;
  }

  if (time->tm_mday < sunday) return before;

  if (time->tm_mday > sunday) return !before;

  if (time->tm_hour < 2) return before;

  return !before;
}

void DateTime::getLocalTime(tm *time) { getLocalTime(date, time); }
...
void DateTime::getLocalTime(int64 milliseconds, tm *time) {
  ...
  if (t >= 0 && milliseconds >= 0) checkConversion(t, time, timeZone);
}

int64 DateTime::getSeconds() { return date / 1000; }

int64 DateTime::getMilliseconds() { return date; }

void DateTime::setSeconds(int64 seconds) { date = MILLISECONDS(seconds); }

void DateTime::setMilliseconds(int64 milliseconds) { date = milliseconds; }
...
bool DateTime::before(DateTime when) { return date < when.date; }

bool DateTime::after(DateTime when) { return date > when.date; }

bool DateTime::equals(DateTime when) { return date == when.date; }

void DateTime::setNull() { date = 0; }

bool DateTime::isNull() { return date == 0; }

int DateTime::compare(DateTime when) {
  if (date > when.date) return 1;
...
void DateTime::getNow(tm *tm) {
  ...
  if (checkDayLightSavings(tm, timeZone)) getYMD(local + timeZone->dst, tm);
...
void DateTime::add(int64 seconds) { date += MILLISECONDS(seconds); }

int Time::getString(int length, char *buffer) {
  tm time;
  getLocalTime(&time);
  // snprintf (buffer, length, "%d-%.2d-%.2d",
  snprintf(buffer, length, "%.2d:%.2d:%.2d", time.tm_hour, time.tm_min,
           time.tm_sec);
...
const TimeZone *DateTime::findTimeZone(const char *string) {
  ...
  for (TimeZone *timeZone = timeZones[slot]; timeZone;
       timeZone = timeZone->collision)
    if (strcasecmp(string, timeZone->name) == 0) return timeZone;

  for (Alias *alias = aliases[slot]; alias; alias = alias->collision)
    if (strcasecmp(string, alias->alias) == 0) return alias->timeZone;
...
#ifdef _WIN32
  if ((defaultTimeZone = DateTime::findTimeZone(_tzname[0])))
#else
...
bool DateTime::isDayLightSavings(tm *time, const TimeZone *timeZone) {
  if (!timeZone->dst) return false;

  TimeZoneRule *timeZoneRule = timeZone->timeZoneRule;
  int year = time->tm_year + 1900;

  while (year < timeZoneRule->year) ++timeZoneRule;

  // Jan to March (now Feb.) and (formerly November and) December are definitely
  // no

  if (time->tm_mon < timeZoneRule->startRule.month ||
      time->tm_mon > timeZoneRule->endRule.month)
    return false;
...
int DateTime::timeRule(tm *time, int64 first, const ZoneRule *rule) {
  ...
  if (rule->day > 0) {
    while (changeDay < day) changeDay += 7;
  } else if (rule->day < 0) {
    int max = monthLengths[time->tm_mon];

    while (changeDay + 7 < max) changeDay += 7;
  }

  if (time->tm_mday < changeDay) return -1;

  if (time->tm_mday > changeDay) return 1;

  int seconds = time->tm_hour * 60 * 60 + time->tm_min * 60 + time->tm_sec;

  if (seconds < rule->time) return -1;
...
void DateTime::checkConversion(time_t t, tm *tm, const TimeZone *timeZone) {
  ...
  if (tm2.tm_mday != tm->tm_mday ||
      tm2.tm_hour != tm->tm_hour)
          ...
          struct tm tm3;
          getYMD (t, &tm3);
          printf ("bad conversion from %d %s(%d): %d:%d %d/%d/%d <> %d:%d
  %d/%d/%d \n", t, timeZone->abbr, timeZone->offset, tm->tm_hour, tm->tm_min,
  tm->tm_mon, tm->tm_mday, tm->tm_year, tm2.tm_hour, tm2.tm_min, tm2.tm_mon,
  tm2.tm_mday, tm2.tm_year);
          }
  ***/
}
